...
//! of how egui works: <https://github.com/emilk/egui/blob/master/crates/nevmes_gui_lib/src/demo/toggle_switch.rs>.
//!
...
pub fn warn_if_debug_build(ui: &mut crate::Ui) {
    if cfg!(debug_assertions) {
        ...
        .on_hover_text("nevmes-gui was compiled with debug assertions enabled.");
    }
}
